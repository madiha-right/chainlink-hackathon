...
contract DeployCore is Tokens, Script {
  ...
  function _deployCoreContracts() private {
    ...
    console.log("connectors", address(connectors));
    console.log("vaults", address(vaults));
    console.log("ccip", address(ccip));
  ...
  function _setConfigs() private {
    ...
    _connectors[0] = 0x7c5c3F1C048bc69486bc747c80DeaC2Dc26ba971; // aave v3 connector
    ...
    _vaults[0] = 0xB95Bb9fA09BCD308B41a7E24A4C1fd730fE8e815; // weth vault
    _vaults[1] = 0x4EC4Af859acBB463f614679eE7aa45068Fbd93A3; // dai vault
