...
contract PositionCompoundV2Mainnet is UniversalPosition, DeployMainnetContracts {
  ...
  function test_OpenPosition_ClosePosition() public {
    ...
    closePosition(user, index, address(sDAIConnector), address(compoundV2Connector), position);
  }
  ...
  function test_OpenAndClose_TwoPosition() public {
    ...
    closePosition(user, index1, address(sDAIConnector), address(compoundV2Connector), position1);
    closePosition(user, index2, address(sDAIConnector), address(compoundV2Connector), position2);
  }
